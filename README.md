...
1. Add next line to your package dependencies in the `Package.swift` file:
    ```swift
    .package(url: "https://github.com/tomtom-international/tomtom-sdk-spm-core", exact: "0.75.0")
    ```
    > We recommend using the `exact` version to have a consistent resolution.
...
For more information, please refer to the [TomTom Maps and Navigation SDK documentation](https://developer.tomtom.com/navigation/ios/introduction/introduction).
